...
import com.kmeisl.schichtkalender.component.InlineTextEditor;
import com.kmeisl.schichtkalender.component.TopTenOffeneSchichtenTable;
    ...
    public final class SortableLayout extends CustomComponent {
        ...
        private Component createComponentFromPaletteItem(
            ...
            if (type == PaletteItemType.TEXT) {
                ...
                result = new TopTenOffeneSchichtenTable();
